...
def boar_brawl(player_score, opponent_score):
    ...
    score = 3 * abs(player_digit - opponent_digit)
...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    largest_roll = 1
    while roll <= 10:
        average_function = make_averaged(roll_dice, samples_count)
        average_number = average_function(roll, dice)
        if largest_number < average_number:
            largest_number = average_number
            largest_roll = roll
        roll += 1
